    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-slate-100 text-sm font-medium text-slate-700">
                {performanceTable.map((s) => (
                  <tr key={s.id} className="hover:bg-slate-50/50 cursor-pointer">
                    <td className="py-3.5 font-bold text-slate-800">
                      <Link href={`/manager/salesmen?id=${s.id}`} className="hover:underline text-indigo-600">
                        {s.name}
                      </Link>
                    </td>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm flex flex-col justify-between">
          ...
          <Link href="/manager/inventory" className="mt-4 inline-flex items-center justify-center rounded-xl bg-slate-100 hover:bg-slate-200 py-2.5 text-xs font-bold text-slate-700 transition-all">
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <div className="flex items-center justify-between mb-6">
          ...
          <Link href="/manager/sales" className="text-xs font-bold text-indigo-600 hover:text-indigo-800 flex items-center">
